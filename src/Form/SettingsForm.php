...
/**
 * Provides settings for loom_cookie module.
 */
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $perm = 'display loom cookie popup';
    ...
    $form['consent_storage']['consent_storage_lifetime'] = [
      '#type' => 'number',
      '#title' => t('Days until stored consents are deleted.'),
      '#default_value' => $config->get('consent_storage_lifetime'),
    ];
    ...
    $form['appearance']['popup_text_hex'] = [
      ...
      '#element_validate' => ['_loom_cookie_validate_hex'],
      '#states' => [
        'visible' => [
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    // Save permissions.
    $permission_name = 'display loom cookie popup';
    ...
    $this->config('loom_cookie.settings')
      ...
      ->set('consent_storage_lifetime', $form_state->getValue('consent_storage_lifetime'))
